...
$result = mysqli_query($conn,"SELECT * FROM waiting'");
...
if(isset($_POST['input']))
  ...
  $var = $_POST['report'];
    ...
    $qer = mysqli_query($conn,"INSERT INTO patient(f_name,last_name,sex,age,added_by,address,email,phone,insurance,insurance_num,pregnant,m_name)
SELECT f_name,last_name,sex,age,added_by,address,email,phone,insurance,insurance_num,pregnant,m_name
FROM waiting WHERE id = '$var'");
if ($qer === TRUE) {
    $del = mysqli_query($conn,"DELETE FROM waiting where id = '$var'");
}
else {
  echo "ERROR: " . $qer . "<br>" . $conn->error . ' on line ' . __LINE__;
}
}
...
<h3 align="center"> Patient Waiting List Index </h3>
<br>
<br>
<div class="container">
<form class="form-group" action="" method="POST">
                         <?php
                                                       $inv = mysqli_query($conn, "Select * from waiting where added_by = '$name'");
                                                      ?>
                                                      <select name="report" id="owner_id"  tabindex="-1" aria-hidden="true" required/>
                                                                          ...
                                                                          <?php endwhile;?>
                                                                          <input type="submit" class="btn btn-primary" name="input" value="Shift to Active Patients" >
 ...
 <div class="container">
 <H4> Patient waiting List Search </H4>
 <br>
...
$inv = "select * from waiting where added_by='$name'";
$atten = mysqli_query($conn,$inv);
          ...
          <td><?php echo $pro['last_name'];?></td>
                      ...
                      <td><?php echo $pro['insurance'];?></td>
                       ...
                       <td>
                         <font color="black"><?php echo date('m/d/Y',strtotime($pro['callin_date']));?>
                       </td>
          					</tr>
