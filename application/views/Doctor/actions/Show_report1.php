...
if(isset($_POST['input']))
  {
    ...
    header('location:DoctorEditreport1');
}
...
if(isset($_POST['delete']))
  {
    $var = $_POST['report'];
    $this->session->set_tempdata('id', $var, 300);
    header('location:DoctorDeletereport1');
}
