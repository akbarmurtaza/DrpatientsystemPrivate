...
if(isset($_POST['input']))
  {
    ...
    $y_old = $_POST['y_old'];
    $y_new = $_POST['y_new'];
    $upd1 = "UPDATE report1 set timeline_year = '$y_new' WHERE timeline_year = '$y_old' AND added_by = '$name'";
    $upd2 = "UPDATE report1 set timeline_month = '$m_new' WHERE timeline_month = '$m_old' AND added_by = '$name'";
