...
$dbname = "drpatient";
  ...
  if(isset($_POST['input']))
    {
  $sql = "UPDATE patient SET f_name = '$fname', last_name = '$lname', sex = '$sex', age = '$age', address = '$address', email = '$email',phone = '$phone',insurance = '$insurance', pregnant = '$preg', m_name = '$mname',insurance_num = '$insurancenum',added_by = '$addedby'  WHERE id = '$id'";
...
<div class="col-xs-8" align="left">
  <div class="form-group" align="left">
    ...
    <br>
    Added by/ Assigned to:<br> <font color="red">(Only Change this if you want to transfer this patient to another account)</font>
    <input class="form-control input-sm" type="text" name="addedby" value="<?php echo $record['added_by'];?>" />
    <br>
    <?php endwhile;?>
    <br>
