...
$dateday = date('Y/m/d h:i:s a', time());
...
$result = mysqli_query($conn,"INSERT into report_log(created_date,created_by,type,time_month,time_year)VALUES('$dateday','$user','Select Records','$month','$date1')");
...
<td style="width: 97px;"><font color="silver"><b>Year</b></font></td>
<td style="width: 97px;"><?php echo $date1 ?></td>
</tr>
<tr>
