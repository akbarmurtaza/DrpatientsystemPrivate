...
<div class="col-xs-8" align="left">
  ...
  <input class="form-control input-sm" type="text" name="timeline_month" value="<?php echo $record['timeline_month'];?>"/>
   ...
   <br>
   Added By/ Assigned to : <font color="red">(Only Change this if you want to transfer the report slot to another account)</font><br>
