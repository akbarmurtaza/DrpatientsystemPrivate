...
$dbname = "drpatient";
  ...
  if(isset($_POST['input']))
    {
  $sql = "INSERT INTO waiting(f_name,last_name,sex,age,added_by,address,email,phone,insurance,insurance_num,pregnant,m_name,callin_date) VALUES('$fname','$lname','$sex','$age','$name','$address','$email','$phone','$insurance','$id','$preg','$mname',STR_TO_DATE('$call', '%m/%d/%Y'))";
  if ($conn->query($sql) === TRUE) {
      echo "<script type='text/javascript'>alert('$message');</script>";
      header('location:DoctorPatientwaiting');
  } else {
...
<form class="form-group" action="" method="POST">
  ...
  <input type="text" name="addedby" value="<?php echo $name;?>" hidden>
  <br>
